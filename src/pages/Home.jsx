            ...
            <Link to={"/signup"}>
                <div className='group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200 transition-all
                 duration-200 hover:scale-95 w-fit'>
                    ...
                    {/* TODO: learn more about the "group" property in tailwind  */}
      ...
      />
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
            <div className='homepage_bg h-[310px]'>
                ...
                {/* Here w-11/12 is a ratio that we'll maintain throughout our website */}

                <div className='h-[150px]'></div>
                {/* Here the above div is used to position the div below */}
